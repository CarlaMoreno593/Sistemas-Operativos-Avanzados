	...
	*/
	...
	//Comienza el intercambio de mensajes
		...
		while(n<cantMensajes){
			...
			//Hace un multicast
			ret = SP_multicast( Mbox, CAUSAL_MESS, "TP-VSOA", 1, longitudMax, mensaje);
...
static int inicializar(int argc, char *argv[]){
	...
	if(argc<6){
		...
		printf("================================================================================\n");
		printf("Forma de Ejecución: ./obj/causal [Demonio] [Usuario] [cantNodos] [cantMensajes] [longMensaje]\n");
